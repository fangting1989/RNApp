...
module.exports = {
    ...
    allbgColor:'#FCFCFC',
    cardDefaultBg: '#fff',
    ft_btnDangerColor:'#D0021B',

    get darkenHeader() {
        return Color(this.allbgColor).darken(0.03).hexString();
    },
    ...
    get btnDangerBg () {
        return this.ft_btnDangerColor;
    },
    get btnDangerColor () {
        return Color(this.ft_btnDangerColor).darken(0.2).hexString();
    },
    get btnInfoBg () {
